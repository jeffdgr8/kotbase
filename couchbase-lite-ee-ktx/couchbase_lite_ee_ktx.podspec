Pod::Spec.new do |spec|
    spec.name                     = 'couchbase_lite_ee_ktx'
    ...
    spec.vendored_frameworks      = 'build/cocoapods/framework/couchbase_lite_ee_ktx.framework'
    spec.libraries                = 'c++'
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'couchbase_lite_ee_ktx',
    }
                
    spec.script_phases = [
        {
            :name => 'Build couchbase_lite_ee_ktx',
