...
/**
 * Creates a new MutableDictionary with content from the passed key/value pairs.
 ...
 */
public fun mutableDictOf(vararg pairs: Pair<String, Any?>): MutableDictionary =
    MutableDictionary(pairs.toMap())
