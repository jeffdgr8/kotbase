Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/Kotbase_Paging.framework') || Dir.empty?('build/cocoapods/framework/Kotbase_Paging.framework')
        raise "

        Kotlin framework 'Kotbase_Paging' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :couchbase-lite-paging:generateDummyFramework
