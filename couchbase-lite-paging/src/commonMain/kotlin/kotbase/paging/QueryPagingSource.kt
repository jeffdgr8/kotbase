...
/**
 * Create a [PagingSource] that pages through all results from the `collection`.
 *
...
@Deprecated(
    ...
    ReplaceWith("QueryPagingSource(context, select, database.getDefaultCollection()!!, mapper")
)
public fun <RowType : Any> QueryPagingSource(
    context: CoroutineContext,
    select: Select,
