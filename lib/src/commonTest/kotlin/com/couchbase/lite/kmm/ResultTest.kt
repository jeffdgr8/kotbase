...
import com.udobny.kmm.ArrayIndexOutOfBoundsException
    ...
    fun testGetDateByKey() {
        for (i in 1..2) {
            ...
            val rows = verifyQuery(query, false) { _, r ->
                ...
                assertEquals(TEST_DATE, r.getDate("date")!!.toStringWithMillis())
    ...
    fun testGetDate() {
        for (i in 1..2) {
            ...
            val rows = verifyQuery(query, false) { _, r ->
                ...
                assertEquals(TEST_DATE, r.getDate(8)!!.toStringWithMillis())
