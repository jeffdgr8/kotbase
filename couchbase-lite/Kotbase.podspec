Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/Kotbase.framework') || Dir.empty?('build/cocoapods/framework/Kotbase.framework')
        raise "

        Kotlin framework 'Kotbase' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :couchbase-lite:generateDummyFramework
