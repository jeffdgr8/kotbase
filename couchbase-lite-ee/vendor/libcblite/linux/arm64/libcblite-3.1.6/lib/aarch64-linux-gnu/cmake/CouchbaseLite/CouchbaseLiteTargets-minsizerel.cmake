...
set_target_properties(cblite PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libcblite.so.3.1.6"
  IMPORTED_SONAME_MINSIZEREL "libcblite.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS cblite )
list(APPEND _IMPORT_CHECK_FILES_FOR_cblite "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libcblite.so.3.1.6" )
