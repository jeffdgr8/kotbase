...
class DateExtTest {
    ...
    fun test_toNativeDateDeep() {
        ...
        assertTrue(output2 is NSDate)
        assertEquals(millis, (output2.timeIntervalSince1970 * 1000).toLong())
    ...
    fun test_toNativeDatesDeep() {
        ...
        assertNull(output[3])
        assertTrue(output[2] is NSDate)
        assertTrue(output[4] is List<*>)
        assertTrue(output[5] is Map<*, *>)
        assertEquals(millis, ((output[2] as NSDate).timeIntervalSince1970 * 1000).toLong())
