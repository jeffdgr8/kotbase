...
class ArrayTestIos : BaseDbTest() {
    ...
    fun testAddObjects() {
        for (i in 0..1) {
            ...
            save(doc, "array", array) { a ->
                ...
                assertEquals(BaseDbTest.TEST_DATE, a.getValue(7))
    ...
    fun testAddObjectsToExistingArray() {
        for (i in 0..1) {
            ...
            save(doc, "array", array) { a ->
                ...
                assertEquals(BaseDbTest.TEST_DATE, a.getValue(12 + 7))
    ...
    fun testSetObjectToExistingArray() {
        for (i in 0..1) {
            ...
            save(doc, "array", gotArray) { a ->
                ...
                assertEquals(BaseDbTest.TEST_DATE, a.getValue(4))
    ...
    fun testGetString() {
        for (i in 0..1) {
            ...
            save(doc, "array", array) { a ->
                ...
                assertEquals(BaseDbTest.TEST_DATE, a.getString(7))
    ...
    fun testGetDate() {
        for (i in 0..1) {
            ...
            save(doc, "array", array) { a ->
                ...
                assertEquals(BaseDbTest.TEST_DATE, a.getDate(7).toString())
    ...
    private fun arrayOfAllTypes(): List<Any?> {
        ...
        list.add(-1)
        list.add(1.1)
        list.add(Instant.parse(BaseDbTest.TEST_DATE))
        list.add(null)
        ...
        // Blob
        list.add(Blob("text/plain", BaseDbTest.BLOB_CONTENT.encodeToByteArray()))
        return list
    }
    ...
    private fun verifyBlob(obj: Any?) {
        ...
        assertContentEquals(BaseDbTest.BLOB_CONTENT.encodeToByteArray(), contents)
        assertEquals(BaseDbTest.BLOB_CONTENT, contents.decodeToString())
    }
}
