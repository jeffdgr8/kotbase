...
abstract class BaseDbTest : BaseTest() {
    ...
    protected fun verifyArray(array: Array?) {
        ...
        assertEquals(Int.MIN_VALUE, array.getValue(4))
        ...
        assertEquals(Int.MIN_VALUE, array.getNumber(4))
        ...
        assertEquals(Int.MAX_VALUE, array.getValue(5))
        ...
        assertEquals(Int.MAX_VALUE, array.getNumber(5))
