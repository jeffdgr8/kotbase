Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/Kotbase_Enterprise_Paging.framework') || Dir.empty?('build/cocoapods/framework/Kotbase_Enterprise_Paging.framework')
        raise "

        Kotlin framework 'Kotbase_Enterprise_Paging' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :couchbase-lite-ee-paging:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'Kotbase_Enterprise_Paging',
    }
                
    spec.script_phases = [
        {
            :name => 'Build Kotbase-Enterprise-Paging',
